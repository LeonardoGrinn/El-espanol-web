...
describe('api', function() {
  ...
  describe('.render(functions)', function() {
    ...
    it('should properly convert boolean when calling custom functions', function(done) {
      sass.render({
        data: 'div { color: if(foo(true, false), $color-terciary, #000);' +
          '\n  background-color: if(foo(true, true), $color-terciary, #000); }',
        functions: {
    ...
    it('should let custom functions call setter methods on wrapped sass values (boolean)', function(done) {
      sass.render({
        data: 'div { color: if(foo(false), $color-terciary, #000); background-color: if(foo(true), $color-terciary, #000); }',
        functions: {
          'foo($a)': function(a) {
    ...
    it('should properly convert lists when calling custom functions', function(done) {
      sass.render({
        data: '$test-list: (bar, #f00, 123em); @each $item in foo($test-list) { .#{$item} { color: $color-terciary; } }',
        functions: {
          'foo($l)': function(list) {
    ...
    it('should properly convert maps when calling custom functions', function(done) {
      sass.render({
        data: '$test-map: foo((abc: 123, #def: true)); div { color: if(map-has-key($test-map, hello), $color-terciary, #000); }' +
    ...
    it('should properly convert null when calling custom functions', function(done) {
      sass.render({
        data: 'div { color: if(foo("bar"), $color-terciary, #000); } ' +
          'span { color: if(foo(null), $color-terciary, #000); }' +
          'table { color: if(bar() == null, $color-terciary, #000); }',
        functions: {
          'foo($a)': function(a) {
