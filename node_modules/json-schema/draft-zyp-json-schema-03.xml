			...
			<section title="format">
				...
				<t>
					...
					<list style="hanging">
						...
						<t hangText="style">This is a CSS style definition (like "color: red; background-color:$color-terciary"), based on <xref target="W3C.CR-CSS21-20070719">CSS 2.1</xref>.</t>
